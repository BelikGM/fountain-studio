...
const ROLES: { id: RoleFilter; label: string; color: string }[] = [
  { id: 'all', label: 'Все', color: '#9aa3ad' },
  { id: 'pump', label: 'Насосы', color: '#4fa3ff' },
  { id: 'valve', label: 'Клапаны', color: '#ff6b6b' },
  { id: 'lamp', label: 'Свет', color: '#ffd166' },
  { id: 'other', label: 'Прочее', color: '#8f9aa6' },
];
  ...
  return (
    <main className="view">
      <section className="panel">
        <h2>Поток DMX</h2>
        <p className="dim">
          Что уходит в линию и что приходит обратно — по участкам пути и по видам приборов. Главное на
          пусконаладке: сравнить «Выход» и «В кабель», чтобы понять, кто виноват — расчёт или переадресация.
        </p>
        ...
        <div className="form-row">
          ...
          {ROLES.map((r) => (
            <button
              ...
              data-hint={r.id === 'all' ? 'Все адреса вселенной' : `Только адреса, занятые приборами вида «${r.label}»`}

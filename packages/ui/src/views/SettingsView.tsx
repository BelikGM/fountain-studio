...
function AudioPanel({ engine }: { engine: EngineConnection }) {
  ...
  return (
    <section className="panel">
      <h2>Звук плейлистов и расписания</h2>
      <p className="dim">
        Громкость и тембр музыки, которую движок играет сам — в плейлистах и по расписанию, в любое время
        дня, в том числе когда редактор закрыт. Меняются с ближайшего следующего трека: обрывать уже
        идущий нельзя — вода уйдёт из-под музыки.
      </p>
      <div className="form-row">
        <label
          className="field"
